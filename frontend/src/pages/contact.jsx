      ...
      <div className="my-10 flex flex-col justify-center md:flex-row gap-10 mb-28">
        ...
        <div className="flex flex-col justify-center items-start gap-6">
          ...
          <p className="text-gray-600 leading-relaxed">
            Have questions about your order or our products? We are here to help you with anything you need.
          </p>
          ...
          <p className="text-gray-500">Contact us for bulk orders</p>
          <a
            href="https://wa.me/8801331759272"
            target="_blank"
