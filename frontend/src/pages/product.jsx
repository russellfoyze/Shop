    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
        ...
        <div className='flex-1'>
          ...
          <div className='flex flex-wrap gap-3 items-center'>
            <button
              ...
              className={`px-8 py-3 text-sm ${!size ? 'cursor-not-allowed bg-slate-400 text-slate-200' : 'bg-black text-white active:bg-gray-700'}`}
            >
              Add To Cart
            </button>
            <button
              ...
              className={`px-8 py-3 text-sm ${!size ? 'cursor-not-allowed bg-slate-400 text-slate-200' : 'bg-orange-500 text-white active:bg-orange-600'}`}
            >
              Buy Now
            </button>
          </div>
      ...
      <div className='mt-5'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-m text-gray-500'>
          <pre className='text-center lg:text-left mt-2 text-gray-500 md:w-4/5 whitespace-pre-wrap'>{productData.description}</pre>
        </div>
      </div>
            ...
            <div className='flex items-start justify-between gap-4'>
              <div>
                ...
                <p className='mt-1 text-sm text-slate-500'>
                  Selected size: <span className='font-semibold text-slate-900'>{size || 'None'}</span>
                </p>
              </div>
            ...
            <div className='mt-6 grid gap-4'>
              ...
              <div className='flex gap-3'>
                <button
                  ...
                  className={`flex-1 rounded-lg border px-4 py-3 text-sm ${paymentMethod === 'cod' ? 'border-black bg-slate-100' : 'border-slate-300 bg-white'}`}
                >
                  Cash on delivery
                </button>
                <button
                  ...
                  className={`flex-1 rounded-lg border px-4 py-3 text-sm ${paymentMethod === 'bkash' ? 'border-black bg-slate-100' : 'border-slate-300 bg-white'}`}
                >
                  bKash
                </button>
              </div>
              ...
              <div className='mt-4 flex flex-col gap-3 sm:flex-row sm:justify-end'>
                <button
                  ...
                  className='rounded-lg border border-slate-300 px-5 py-3 text-sm text-slate-600 hover:bg-slate-100'
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={loading}
                  className='rounded-lg bg-black px-5 py-3 text-sm text-white hover:bg-slate-800'
                >
