    ...
    <div>
      ...
      <div className='flex flex-col md:flex-row text-sm mb-20'>
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b className='text-lg'>Quality Products</b>
          <p className='text-gray-600'>We carefully select every product to ensure high quality, durability, and value for our customers.</p>
        </div>
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b className='text-lg'>Wide Collection</b>
          <p className='text-gray-600'>From casual wear to premium styles, explore a wide range of products for men, women, and kids.</p>
        </div>
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b className='text-lg'>Customer Support</b>
          <p className='text-gray-600'>Our team is always ready to help with orders, returns, and any questions you may have.</p>
        </div>
      </div>
    </div>
  )
